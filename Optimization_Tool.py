...
construction_sites = np.array([[2, 3, 4],
                               [1, 3, 2],
                               [0, 2, 3],
                               [2, 3, 0],
                               [1, 3, 2],
...
mat_required = np.sum(construction_sites, axis=0)
...
required_materials = {(i, materials[k]): construction_sites[i-1, k] for i in range(1, n + 1) for k in range(len(materials))}


# storage distribution
# tot_storage_requirement = np.sum(construction_sites)
